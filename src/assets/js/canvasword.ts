//鼠标点击出现爱心特效
(function (window: any, document: any, undefined) {
  var hearts: Array<any> = [];
  ...
  function createHeart(event: any) {
    const slogans: Array<string> = ['富强', '民主', '文明', '和谐', '自由', '平等', '公正', '法治', '爱国', '敬业', '诚信', '友善']
    var d = document.createElement("div");
    const word_child = document.createElement("span");
    word_child.innerText = slogans[Math.floor(Math.random() * 12)];
